...
export default function ActiveAssignmentsBoard() {
  ...
  if (isError) {
    return <div className="text-red-500">Không thể tải các phân công.</div>;
  }
  ...
  if (activeAssignments.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-64 border border-dashed rounded-xl text-slate-500">
        ...
        <p>Không có phân công bệnh nhân nào đang hoạt động.</p>
      </div>
    );
  }
  return (
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold tracking-tight">
            Danh sách phân công hoạt động
          </h2>
          <p className="text-sm text-slate-500">
            Tổng quan các phân công nội trú hiện tại.
          </p>
        </div>
        <Badge
          variant="secondary"
            ...
            >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500">
                        ...
                        {patient.bloodgroup || "Không rõ nhóm máu"}
                      </p>
                    </div>
                  </div>
                  {isHighlighted && (
              ...
              <CardContent className="p-4 pt-3 space-y-3">
                ...
                <div className="text-xs">
                  ...
                  >
                    {patient.medicalHistory || "Không có lịch sử y tế."}
                  </p>
                </div>
